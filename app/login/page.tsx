      ...
      <div className="container mx-auto max-w-4xl px-6 py-16">
        ...
        >
          ...
          <p className="mx-auto mb-8 max-w-2xl text-base text-muted-foreground md:text-lg">
            Access your dashboard to claim CLI projects, import repositories, and
            monitor vulnerabilities across all your projects
          </p>
          ...
          >
            ...
            <Card className="border border-border/40 text-left shadow-md">
              <CardHeader>
                ...
                <CardDescription className="text-sm">
                  Connect your GitHub repositories for continuous monitoring
